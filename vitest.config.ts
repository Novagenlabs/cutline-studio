...
export default defineConfig({
  ...
  test: {
    ...
    include: ['test/{credits,hash,render,raster-framing,e2e-export,signup-grant,same-origin,render-timing,whop,subscription-credits,filename,disposition,signout,cutout}.test.ts'],
  },
});
